...
import "MedicamentosModel.dart" show Medicamento, MedicamentosModel, medicamentosModel;
...
class MedicamentosList extends StatelessWidget {
          ...
          return Scaffold(
            ...
            body : ListView.builder(
              ...
              itemBuilder : (BuildContext inBuildContext, int inIndex) {
                Medicamento medicamento = medicamentosModel.entityList[inIndex];
                ...
                // Create the Slidable.
                return Slidable(
                  actionPane : SlidableDrawerActionPane(),//SlidableDrawerDelegate(),
                  actionExtentRatio : .25,
                  child : ListTile(
                    leading : Checkbox(
                      value : medicamento.completed == "true" ? true : false,
                    ...
                    onTap : () async {
                      ...
                      if (medicamento.completed == "true") { return; }
                      // Get the data from the database and send to the edit view.
                      medicamentosModel.entityBeingEdited = await MedicamentosDB.db.get(medicamento.id);
                      // Parse out the due date, if any, and set it in the model for display.
                      if (medicamentosModel.entityBeingEdited.dueDate == null) {
                        medicamentosModel.setChosenDate(null);
                      } else {
                  ...
                  secondaryActions : [
                    IconSlideAction(
                      ...
                      color : Colors.red,
                      icon : Icons.delete,
                      onTap : () => _deleteMedicamento(inContext, medicamento)
                    )
                  ], 
                ); /* End Slidable. */
              } /* End itemBuilder. */
  ...
  /// @return           Future.
  Future _deleteMedicamento(BuildContext inContext, Medicamento inMedicamento) async {

    print("##13 MedicamentosList._deleteMedicamento(): inMedicamento = $inMedicamento");
    ...
    return showDialog(
      ...
      builder : (BuildContext inAlertContext) {
        return AlertDialog(
          ...
          content : Text("Are you sure you want to delete ${inMedicamento.description}?"),
          actions : [
