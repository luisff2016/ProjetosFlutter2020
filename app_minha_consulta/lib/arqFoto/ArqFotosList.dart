...
class ArqFotosList extends StatelessWidget {
          ...
          return Scaffold(
              ...
              floatingActionButton: FloatingActionButton(
                  ...
                  onPressed: () async {
                    ...
                    arqFotosModel.entidadeSendoEditada.apptDate =
  ...
  void _showArqFotos(DateTime inDate, BuildContext inContext) async {
    ...
    print(
        "##99 ArqFotosList._showArqFotos(): arqFotosModel.listaEntidades.length = "
                              ...
                              Expanded(
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (BuildContext inBuildContext,
                                          int inIndex) {
                                        ArqFoto arqFoto = arqFotosModel
                                            .listaEntidades[inIndex];
                                        print(
                                            "##101 ArqFotosList._showArqFotos().ListView.builder(): "
                                            "arqFoto = $arqFoto");
                                        ...
                                        return Slidable(
                                            ...
                                            secondaryActions: [
                                              IconSlideAction(
                                                  ...
                                                  color: Colors.red,
                                                  icon: Icons.delete,
                                                  onTap: () => _deleteArqFoto(
                                                      inBuildContext, arqFoto))
                                            ]); /* End Slidable. */
                                      } /* End itemBuilder. */
    ...
    return showDialog(
        ...
        builder: (BuildContext inAlertContext) {
          return AlertDialog(
              ...
              content:
                  Text("Are you sure you want to delete ${inArqFoto.title}?"),
              actions: [
                FlatButton(
                    child: Text("Cancel"),
                    onPressed: () {
