...
class ArqFotosModel extends BaseModel {

  /// The ArqFotos time.  Needed to be able to display what the user picks in the Text widget on the entry screen.
  String apptTime;

  /// For display of the ArqFotos time chosen by the user.
...
ArqFotosModel arqFotosModel = ArqFotosModel();