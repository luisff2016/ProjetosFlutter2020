...
class ArqDocumentosModel extends BaseModel {

  /// The ArqDocumento time.  Needed to be able to display what the user picks in the Text widget on the entry screen.
  String apptTime;

  /// For display of the ArqDocumento time chosen by the user.
  ///
  /// @param inApptTime The ArqDocumento date in HH:MM form.
...
ArqDocumentosModel arqDocumentosModel = ArqDocumentosModel();