...
import "ArqDocumentosModel.dart"
    show ArqDocumento, ArqDocumentosModel, arqDocumentosModel;
...
class ArqDocumentosList extends StatelessWidget {
          ...
          return Scaffold(
              ...
              floatingActionButton: FloatingActionButton(
                  ...
                  onPressed: () async {
                    ...
                    arqDocumentosModel.entidadeSendoEditada.apptDate =
              ...
              body: Column(children: [
                Expanded(
                    child: Container(
                        ...
                        child: Text(
                            "listar documentos em pdf ...")) /* End Container. */
                    ) /* End Expanded. */
              ] /* End Column.children. */
                  ) /* End Column. */
              ); /* End Scaffold. */
  ...
  void _showArqDocumentos(DateTime inDate, BuildContext inContext) async {
    ...
    print(
        "##99 ArqDocumentosList._showArqDocumentos(): arqDocumentosModel.listaEntidades.length = "
        "${arqDocumentosModel.listaEntidades.length}");

    print(
        "##100 ArqDocumentosList._showArqDocumentos(): arqDocumentosModel.listaEntidades = "
                                      ...
                                      itemBuilder: (BuildContext inBuildContext,
                                        ...
                                        return Slidable(
                                            ...
                                            child: Container(
                                                ...
                                                child: ListTile(
                                                    title: Text(
                                                        "${arqDocumento.title}$apptTime"),
                                                    subtitle: arqDocumento
                                                                .description ==
                                                            null
                                                        ? null
                                                        : Text(
                                                            "${arqDocumento.description}"),
  ...
  void _editArqDocumento(
      BuildContext inContext, ArqDocumento inArqDocumento) async {
    print(
        "##103 ArqDocumentosList._editArqDocumento(): inArqDocumento = $inArqDocumento");

    // Get the data from the database and send to the edit view.
    arqDocumentosModel.entidadeSendoEditada =
        await ArqDocumentosDB.db.get(inArqDocumento.id);
    ...
    if (arqDocumentosModel.entidadeSendoEditada.apptDate == null) {
      ...
      List dateParts =
          arqDocumentosModel.entidadeSendoEditada.apptDate.split(",");
    ...
    if (arqDocumentosModel.entidadeSendoEditada.apptTime == null) {
      ...
      List timeParts =
          arqDocumentosModel.entidadeSendoEditada.apptTime.split(",");
  ...
  /// @return               Future.
  Future _deleteArqDocumento(
      BuildContext inContext, ArqDocumento inArqDocumento) async {
    print(
        "##104 ArqDocumentosList._deleteArqDocumento(): inArqDocumento = $inArqDocumento");
    ...
    return showDialog(
        ...
        builder: (BuildContext inAlertContext) {
          return AlertDialog(
              ...
              content: Text(
                  "Are you sure you want to delete ${inArqDocumento.title}?"),
              actions: [
                FlatButton(
                    child: Text("Cancel"),
                    onPressed: () {
                ...
                FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      arqDocumentosModel.loadData(
                          "arqDocumentos", ArqDocumentosDB.db);
                    })
              ]);
        });
