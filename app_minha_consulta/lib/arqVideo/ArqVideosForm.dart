...
/// ********************************************************************************************************************
/// The ArqVideos Entry sub-screen.
/// ********************************************************************************************************************
class ArqVideosForm extends StatelessWidget {
  ...
  ArqVideosForm() {
    ...
    print("##105 ArqVideosForm.constructor");

    // Attach event listeners to controllers to capture entries in model.
    _titleEditingController.addListener(() {
      arqVideosModel.entidadeSendoEditada.title = _titleEditingController.text;
    });
    _descriptionEditingController.addListener(() {
      arqVideosModel.entidadeSendoEditada.description = _descriptionEditingController.text;
    });
  ...
  Widget build(BuildContext inContext) {
    ...
    print("##106 ArqVideosForm.build()");

    // Set value of controllers.
    _titleEditingController.text = arqVideosModel.entidadeSendoEditada.title;
    _descriptionEditingController.text = arqVideosModel.entidadeSendoEditada.description;
            ...
            bottomNavigationBar : Padding(
              ...
              child : Row(
                children : [
                  ...
                  FlatButton(
                    child : Text("Save"),
                    onPressed : () { _save(inContext, arqVideosModel); }
                  )
                ]
              )
            ),
              ...
              child : ListView(
                children : [
                  ...
                  ListTile(
                    ...
                    title : Text("Date"),
                    subtitle : Text(arqVideosModel.dataEscolhida == null ? "" : arqVideosModel.dataEscolhida),
                    trailing : IconButton(
                      ...
                      onPressed : () async {
                        ...
                        String dataEscolhida = await utils.selectDate(
                          inContext, arqVideosModel, arqVideosModel.entidadeSendoEditada.apptDate
                        );
                        if (dataEscolhida != null) {
                          arqVideosModel.entidadeSendoEditada.apptDate = dataEscolhida;
                        }
                      }
                    )
                  ),
                  ...
                  ListTile(
                    ...
                    title : Text("Time"),
                    subtitle : Text(arqVideosModel.apptTime == null ? "" : arqVideosModel.apptTime),
                    trailing : IconButton(
                      icon : Icon(Icons.edit),
                      color : Colors.blue,
  ...
  Future _selectTime(BuildContext inContext) async {
    ...
    if (picked != null) {
      arqVideosModel.entidadeSendoEditada.apptTime = "${picked.hour},${picked.minute}";
      arqVideosModel.setApptTime(picked.format(inContext));
    }
  ...
  ///
  /// @param inContext The BuildContext of the parent widget.
  /// @param inModel   The ArqVideosModel.
  void _save(BuildContext inContext, ArqVideosModel inModel) async {

      print("##107 ArqVideosForm._save()");
      ...
      if (inModel.entidadeSendoEditada.id == null) {
        ...
        print("##108 ArqVideosForm._save(): Creating: ${inModel.entidadeSendoEditada}");
        await ArqVideosDB.db.create(arqVideosModel.entidadeSendoEditada);

      // Updating an existing appointment.
      } else {

        print("##109 ArqVideosForm._save(): Updating: ${inModel.entidadeSendoEditada}");
        await ArqVideosDB.db.update(arqVideosModel.entidadeSendoEditada);
