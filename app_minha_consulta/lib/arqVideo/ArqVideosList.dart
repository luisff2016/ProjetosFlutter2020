...
class ArqVideosList extends StatelessWidget {
          ...
          return Scaffold(
              ...
              floatingActionButton: FloatingActionButton(
                  ...
                  onPressed: () async {
                    ...
                    arqVideosModel.entidadeSendoEditada.apptDate =
              ...
              body: Column(children: [
                Expanded(
                    child: Container(
                        ...
                        child: Text("listar arquivos de videos")
                        ) /* End Container. */
                    ) /* End Expanded. */
              ] /* End Column.children. */
                  ) /* End Column. */
  ...
  void _showArqVideos(DateTime inDate, BuildContext inContext) async {
    ...
    print(
        "##99 ArqVideosList._showArqVideos(): arqVideosModel.listaEntidades.length = "
        "${arqVideosModel.listaEntidades.length}");
    print(
        "##100 ArqVideosList._showArqVideos(): arqVideosModel.listaEntidades = "
                                      ...
                                      itemBuilder: (BuildContext inBuildContext,
                                        ...
                                        return Slidable(
                                            ...
                                            child: Container(
                                                ...
                                                child: ListTile(
                                                    title: Text(
                                                        "${arqVideo.title}$apptTime"),
                                                    subtitle: arqVideo
                                                                .description ==
                                                            null
                                                        ? null
                                                        : Text(
                                                            "${arqVideo.description}"),
                                            ...
                                            secondaryActions: [
                                              IconSlideAction(
                                                  ...
                                                  color: Colors.red,
                                                  icon: Icons.delete,
                                                  onTap: () => _deleteArqVideo(
                                                      inBuildContext, arqVideo))
                                            ]); /* End Slidable. */
                                      } /* End itemBuilder. */
  ...
  void _editArqVideo(BuildContext inContext, ArqVideo inArqVideo) async {
    ...
    arqVideosModel.entidadeSendoEditada =
        await ArqVideosDB.db.get(inArqVideo.id);
    ...
    return showDialog(
        ...
        builder: (BuildContext inAlertContext) {
          return AlertDialog(
              ...
              content:
                  Text("Are you sure you want to delete ${inArqVideo.title}?"),
              actions: [
                FlatButton(
                    child: Text("Cancel"),
                    onPressed: () {
