...
/// ********************************************************************************************************************
class ArqVideosModel extends BaseModel {

  /// The ArqVideo time.  Needed to be able to display what the user picks in the Text widget on the entry screen.
  String apptTime;

  /// For display of the ArqVideo time chosen by the user.
  ///  /// @param inApptTime The ArqVideo date in HH:MM form.
...
ArqVideosModel arqVideosModel = ArqVideosModel();
