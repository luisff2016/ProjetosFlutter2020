...
/// ********************************************************************************************************************
class ArqAudiosModel extends BaseModel {

  /// The Audio time.  Needed to be able to display what the user picks in the Text widget on the entry screen.
  String apptTime;

  /// For display of the Audio time chosen by the user.
  ///
  /// @param inApptTime The Audio date in HH:MM form.
...
ArqAudiosModel arqAudiosModel = ArqAudiosModel();